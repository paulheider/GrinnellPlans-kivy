...
requirements = openssl,requests,kivy==2.0.0rc4,python3
####TODO - requirements = python3,kivy==2.0.0rc4,certifi,openssl,requests,urllib3,simplejson
...
android.ndk_path = /home/paul/Android/android-ndk-r19c
